...
func handler(ctx context.Context, event events.APIGatewayProxyRequest) (events.APIGatewayProxyResponse, error) {
	updateDepartmentRequest, err := utils.DecodeJson[dtos.UpdateDepartmentRequest](event.Body)
	if err != nil {
	...
	err = departmentService.UpdateDepartment(ctx, departmentDomain)
	if err != nil {
	...
	return utils.BuildResponse(http.StatusOK, "department updated successfully", struct{}{}), nil
}
